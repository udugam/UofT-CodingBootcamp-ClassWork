...
while True :
    ...
    print('The student\'s first name is {0}'.format(student['first_name']))
    print('The student\'s last name is {0}'.format(student['last_name']))
    print('The student\'s middle initial is {0}'.format(student['middle_initial']))

    print('The student\'s address is {0}'.format(student['address']))
    print('The student\'s email is {0}'.format(student['email']))
    print('The student\'s phone number is {0}'.format(student['phone_number']))
