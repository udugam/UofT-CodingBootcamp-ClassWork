...
const names2 = princesses.map(function(princess) {
...
const mNames2 = names.filter(function(name) {
  return name.startsWith("M");
})
console.log("m-names: ", mNames2);
...
const sum2 = princesses.reduce(function(sum, princess) {
  return sum+princess.age
},0)
const average2 = sum2/princesses.length
console.log("average age: ", average2);
