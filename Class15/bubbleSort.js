...
var unsorted2 = [7,6,5,4,3,2,1];


function bubbleSortArray(numbers) {
  for (var i=0; i<numbers.length; i++) {
    // console.log("New Loop");
    if (numbers[i] > numbers[i+1]) {
      var newCurrent = numbers[i+1];
      var newNext = numbers[i];
      numbers[i] = newCurrent;
      numbers[i+1] = newNext;
      // console.log(numbers);
